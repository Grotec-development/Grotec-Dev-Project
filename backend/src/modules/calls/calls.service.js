...
let CallsService = class CallsService {
    constructor(prisma, audit, dialers, customers, messaging, config) {
        ...
        this.config = config;
        this.logger = new Logger('CallsService');
    }
    // ------------------------------------------------------------------- dialing
    async placeCall(actor, dto) {
        ...
        if (dto.leadId) {
            ...
            if (actor.roleCode === 'AGENT') {
                ...
                if (!owned) {
                    throw ApiError.forbidden('LEAD_LINK_FORBIDDEN', 'You can only link calls to leads you own');
                }
            }
        }
        else if (customerId) {
    ...
    async queueProductMessage(tx, actor, call) {
        ...
        if (!phone)
            throw ApiError.conflict('CUSTOMER_PHONE_REQUIRED', 'Customer has no primary phone for the product message');
...
CallsService = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [typeof (_a = typeof PrismaService !== "undefined" && PrismaService) === "function" ? _a : Object, typeof (_b = typeof AuditService !== "undefined" && AuditService) === "function" ? _b : Object, typeof (_c = typeof DialerRegistry !== "undefined" && DialerRegistry) === "function" ? _c : Object, typeof (_d = typeof CustomersService !== "undefined" && CustomersService) === "function" ? _d : Object, typeof (_e = typeof MessagingService !== "undefined" && MessagingService) === "function" ? _e : Object, typeof (_f = typeof ConfigService !== "undefined" && ConfigService) === "function" ? _f : Object])
], CallsService);
export { CallsService };
