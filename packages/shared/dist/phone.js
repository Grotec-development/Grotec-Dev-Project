...
exports.isPlausiblePhoneInput = isPlausiblePhoneInput;
...
function isPlausiblePhoneInput(value) {
...
function normalizePhoneToE164(value) {
    ...
    if (!DIGITS_ONLY.test(cleaned) || cleaned.length < 10 || cleaned.length > 15)
        return null;
