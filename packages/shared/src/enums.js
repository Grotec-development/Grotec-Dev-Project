...
export const ACTIVE_CALL_STATUSES = ['DIALING', 'RINGING', 'CONNECTED'];
export const TERMINAL_CALL_STATUSES = ['ENDED', 'NOT_ANSWERED', 'FAILED'];
...
export const CALL_OUTCOMES = ['INTERESTED', 'NOT_INTERESTED', 'NOT_ANSWERED'];
...
export const PROBLEM_TYPES = ['PEST', 'DISEASE', 'NUTRIENT_DEFICIENCY', 'WEED', 'OTHER'];
...
export const CROP_CATEGORIES = ['FIELD', 'TREE', 'PLANTATION', 'VEGETABLE', 'OTHER'];
